 ...
 * @since 2016-05-19
 */
public class BearAVCallFloatView extends FrameLayout {
    private static final String TAG = "BearAVCallFloatView";
    ...
    public BearAVCallFloatView(Context context) {
        super(context);
        initView();
    }
    ...
    private void initView() {
        ...
        View floatView = inflater.inflate(R.layout.float_view_bear, null);
...
//    }
    ...
    private class AnchorAnimRunnable implements Runnable {
        ...
        public void run() {
            ...
            windowManager.updateViewLayout(BearAVCallFloatView.this, mParams);
            BearAVCallFloatView.this.postDelayed(this, 16);
        }
    }
