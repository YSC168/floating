...
public class BallFloatWindowManager {
    private static final String TAG = "BallFloatWindowManager";

    private static volatile BallFloatWindowManager instance;

    private boolean isWindowDismiss = true;
    private WindowManager windowManager = null;
    private WindowManager.LayoutParams mParams = null;
    private BallAVCallFloatView floatView = null;
    private Dialog dialog;

    public static BallFloatWindowManager getInstance() {
        if (instance == null) {
            synchronized (BallFloatWindowManager.class) {
                if (instance == null) {
                    instance = new BallFloatWindowManager();
                }
            }
        }
        return instance;
...
//        imageView.setImageResource(R.drawable.app_icon);
        floatView = new BallAVCallFloatView(context);
