...
public class HeartFloatWindowManager {
    private static final String TAG = "HeartFloatWindowManager";

    private static volatile HeartFloatWindowManager instance;

    private boolean isWindowDismiss = true;
    private WindowManager windowManager = null;
    private WindowManager.LayoutParams mParams = null;
    private HeartAVCallFloatView floatView = null;
    private Dialog dialog;

    public static HeartFloatWindowManager getInstance() {
        if (instance == null) {
            synchronized (HeartFloatWindowManager.class) {
                if (instance == null) {
                    instance = new HeartFloatWindowManager();
                }
            }
        }
        return instance;
...
//        imageView.setImageResource(R.drawable.app_icon);
        floatView = new HeartAVCallFloatView(context);
