...
public class DuckFloatWindowManager {
    private static final String TAG = "DuckFloatWindowManager";

    private static volatile DuckFloatWindowManager instance;

    private boolean isWindowDismiss = true;
    private WindowManager windowManager = null;
    private WindowManager.LayoutParams mParams = null;
    private DuckAVCallFloatView floatView = null;
    private Dialog dialog;

    public static DuckFloatWindowManager getInstance() {
        if (instance == null) {
            synchronized (DuckFloatWindowManager.class) {
                if (instance == null) {
                    instance = new DuckFloatWindowManager();
                }
            }
        }
        return instance;
    ...
    private void showWindow(Context context) {
        ...
        mParams.x = screenWidth - dp2px(context, 400);
        mParams.y = screenHeight - dp2px(context, 200);


//        ImageView imageView = new ImageView(mContext);
//        imageView.setImageResource(R.drawable.app_icon);
        floatView = new DuckAVCallFloatView(context);
