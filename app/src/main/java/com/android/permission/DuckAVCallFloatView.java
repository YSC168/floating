 ...
 * @since 2016-05-19
 */
public class DuckAVCallFloatView extends FrameLayout {
    private static final String TAG = "DuckAVCallFloatView";
    ...
    public DuckAVCallFloatView(Context context) {
        super(context);
        initView();
    }
    ...
    private void initView() {
        ...
        View floatView = inflater.inflate(R.layout.float_view_duck, null);
...
//    }
    ...
    private class AnchorAnimRunnable implements Runnable {
        ...
        public void run() {
            ...
            windowManager.updateViewLayout(DuckAVCallFloatView.this, mParams);
            DuckAVCallFloatView.this.postDelayed(this, 16);
        }
    }
