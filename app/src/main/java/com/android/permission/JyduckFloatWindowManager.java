...
public class JyduckFloatWindowManager {
    private static final String TAG = "JyduckFloatWindowManager";

    private static volatile JyduckFloatWindowManager instance;

    private boolean isWindowDismiss = true;
    private WindowManager windowManager = null;
    private WindowManager.LayoutParams mParams = null;
    private JyduckAVCallFloatView floatView = null;
    private Dialog dialog;

    public static JyduckFloatWindowManager getInstance() {
        if (instance == null) {
            synchronized (JyduckFloatWindowManager.class) {
                if (instance == null) {
                    instance = new JyduckFloatWindowManager();
                }
            }
        }
        return instance;
    ...
    private void showWindow(Context context) {
        ...
        mParams.y = screenHeight - dp2px(context, 200);


//        ImageView imageView = new ImageView(mContext);
//        imageView.setImageResource(R.drawable.app_icon);
        floatView = new JyduckAVCallFloatView(context);
