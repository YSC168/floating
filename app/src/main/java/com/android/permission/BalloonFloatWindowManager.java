...
public class BalloonFloatWindowManager {
    private static final String TAG = "BalloonFloatWindowManager";

    private static volatile BalloonFloatWindowManager instance;

    private boolean isWindowDismiss = true;
    private WindowManager windowManager = null;
    private WindowManager.LayoutParams mParams = null;
    private BalloonAVCallFloatView floatView = null;
    private Dialog dialog;

    public static BalloonFloatWindowManager getInstance() {
        if (instance == null) {
            synchronized (BalloonFloatWindowManager.class) {
                if (instance == null) {
                    instance = new BalloonFloatWindowManager();
                }
            }
        }
        return instance;
...
//        imageView.setImageResource(R.drawable.app_icon);
        floatView = new BalloonAVCallFloatView(context);
