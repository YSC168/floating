 ...
 * @since 2016-05-19
 */
public class BearLikeAVCallFloatView extends FrameLayout {
    private static final String TAG = "BearLikeAVCallFloatView";
    ...
    public BearLikeAVCallFloatView(Context context) {
        super(context);
        initView();
    }
    ...
    private void initView() {
        ...
        View floatView = inflater.inflate(R.layout.float_view_likebear, null);
...
//    }
    ...
    private class AnchorAnimRunnable implements Runnable {
        ...
        public void run() {
            ...
            windowManager.updateViewLayout(BearLikeAVCallFloatView.this, mParams);
            BearLikeAVCallFloatView.this.postDelayed(this, 16);
        }
    }
