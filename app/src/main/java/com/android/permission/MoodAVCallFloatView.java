 ...
 * @since 2016-05-19
 */
public class MoodAVCallFloatView extends FrameLayout {
    private static final String TAG = "MoodAVCallFloatView";
    ...
    public MoodAVCallFloatView(Context context) {
        super(context);
        initView();
    }
    ...
    private void initView() {
        ...
        View floatView = inflater.inflate(R.layout.float_view_mood, null);
...
//    }
    ...
    private class AnchorAnimRunnable implements Runnable {
        ...
        public void run() {
            ...
            windowManager.updateViewLayout(MoodAVCallFloatView.this, mParams);
            MoodAVCallFloatView.this.postDelayed(this, 16);
        }
    }
