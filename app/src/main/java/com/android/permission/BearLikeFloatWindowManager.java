...
public class BearLikeFloatWindowManager {
    private static final String TAG = "BearLikeFloatWindowManager";

    private static volatile BearLikeFloatWindowManager instance;

    private boolean isWindowDismiss = true;
    private WindowManager windowManager = null;
    private WindowManager.LayoutParams mParams = null;
    private BearLikeAVCallFloatView floatView = null;
    private Dialog dialog;

    public static BearLikeFloatWindowManager getInstance() {
        if (instance == null) {
            synchronized (BearLikeFloatWindowManager.class) {
                if (instance == null) {
                    instance = new BearLikeFloatWindowManager();
                }
            }
        }
        return instance;
    ...
    private void showWindow(Context context) {
        ...
        mParams.x = screenWidth - dp2px(context, 200);
        mParams.y = screenHeight - dp2px(context, 300);


//        ImageView imageView = new ImageView(mContext);
//        imageView.setImageResource(R.drawable.app_icon);
        floatView = new BearLikeAVCallFloatView(context);
