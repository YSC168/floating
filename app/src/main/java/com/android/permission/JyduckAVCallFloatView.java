 ...
 * @since 2016-05-19
 */
public class JyduckAVCallFloatView extends FrameLayout {
    private static final String TAG = "JyduckAVCallFloatView";
    ...
    public JyduckAVCallFloatView(Context context) {
        super(context);
        initView();
    }
    ...
    private void initView() {
        ...
        View floatView = inflater.inflate(R.layout.float_view_jyduck, null);
...
//    }
    ...
    private class AnchorAnimRunnable implements Runnable {
        ...
        public void run() {
            ...
            windowManager.updateViewLayout(JyduckAVCallFloatView.this, mParams);
            JyduckAVCallFloatView.this.postDelayed(this, 16);
        }
    }
