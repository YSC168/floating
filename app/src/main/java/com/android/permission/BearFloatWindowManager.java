...
public class BearFloatWindowManager {
    private static final String TAG = "BearFloatWindowManager";

    private static volatile BearFloatWindowManager instance;

    private boolean isWindowDismiss = true;
    private WindowManager windowManager = null;
    private WindowManager.LayoutParams mParams = null;
    private BearAVCallFloatView floatView = null;
    private Dialog dialog;

    public static BearFloatWindowManager getInstance() {
        if (instance == null) {
            synchronized (BearFloatWindowManager.class) {
                if (instance == null) {
                    instance = new BearFloatWindowManager();
                }
            }
        }
        return instance;
...
//        imageView.setImageResource(R.drawable.app_icon);
        floatView = new BearAVCallFloatView(context);
