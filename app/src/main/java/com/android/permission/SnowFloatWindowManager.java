...
public class SnowFloatWindowManager {
    private static final String TAG = "SnowFloatWindowManager";

    private static volatile SnowFloatWindowManager instance;

    private boolean isWindowDismiss = true;
    private WindowManager windowManager = null;
    private WindowManager.LayoutParams mParams = null;
    private SnowAVCallFloatView floatView = null;
    private Dialog dialog;

    public static SnowFloatWindowManager getInstance() {
        if (instance == null) {
            synchronized (SnowFloatWindowManager.class) {
                if (instance == null) {
                    instance = new SnowFloatWindowManager();
                }
            }
        }
        return instance;
...
//        imageView.setImageResource(R.drawable.app_icon);
        floatView = new SnowAVCallFloatView(context);
