...
public class MoodFloatWindowManager {
    private static final String TAG = "MoodFloatWindowManager";

    private static volatile MoodFloatWindowManager instance;

    private boolean isWindowDismiss = true;
    private WindowManager windowManager = null;
    private WindowManager.LayoutParams mParams = null;
    private MoodAVCallFloatView floatView = null;
    private Dialog dialog;

    public static MoodFloatWindowManager getInstance() {
        if (instance == null) {
            synchronized (MoodFloatWindowManager.class) {
                if (instance == null) {
                    instance = new MoodFloatWindowManager();
                }
            }
        }
        return instance;
    ...
    private void showWindow(Context context) {
        ...
        mParams.x = screenWidth - dp2px(context, 300);
        mParams.y = screenHeight - dp2px(context, 200);


//        ImageView imageView = new ImageView(mContext);
//        imageView.setImageResource(R.drawable.app_icon);
        floatView = new MoodAVCallFloatView(context);
